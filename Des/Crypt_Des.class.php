...
/*$a='十年生死两茫茫，不思量，自难相忘';
import("Org.Crypt.Crypt_Des");
$des = new Crypt_Des(CRYPT_DES_MODE_ECB);
$des->setKey('BC0F84173486496C925B8814F19790E80AB1418257D94114');
$des_xml=$des->encrypt($a);
print_r(base64_encode($des_xml));print_r('<br/>');
$de=$des->decrypt($des_xml);
print_r($de);*/
